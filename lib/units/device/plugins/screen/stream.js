      ...
      .then(function(wss) {
        ...
        wss.on('connection', function(ws) {
          ...
          function wsFrameNotifier(frame) {
            ...
            log.info('A Current time : '+currentTime)
            log.info('A Last sent time : '+lastSentTime)
            log.info('Min sent interval : '+options.minSentInterval)
            if (currentTime - lastSentTime < options.minSentInterval) {
              log.info('Woy Masuk interval jadi gak ngirim!')
              return Promise.resolve()
            }
            else {
              log.info('Woy Ngirim euy!!')
