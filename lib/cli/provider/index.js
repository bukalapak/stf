...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    .option('min-sent-interval', {
      describe: 'Interval time in milisecond where stf will sent the frame. ' +
        'For example if we set the value to 3000 (3s), stf will sent the frame every 3s.'
    , type: 'number'
    , default: process.env.MIN_SENT_INTERVAL || 100
    })
...
module.exports.handler = function(argv) {
  ...
  , fork: function(device, ports) {
      ...
      , '--min-sent-interval', argv.minSentInterval
